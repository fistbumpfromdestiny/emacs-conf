(custom-set-variables
 ...
 '(package-selected-packages
   '(undo-tree org-roam no-littering auto-package-update counsel-projectile projectile paredit cider clojure-mode flycheck-clj-kondo yasnippet lsp-ivy forge magit visual-fill-column org-bullets doom-modeline dired-hide-dotfiles dired-open all-the-icons-dired dired-single eshell-git-prompt evil-nerd-commenter company-box lsp-java lsp-ui dap-mode lsp-treemacs flycheck))
